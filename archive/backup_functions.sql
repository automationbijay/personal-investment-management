...
AS $function$
        DECLARE
            ...
            v_today_ltp REAL;
        BEGIN
            -- 1. Get LTP for the weekly nav date (Fallback to earlier if holiday)
